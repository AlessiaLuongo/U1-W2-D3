...
/* ESERCIZIO 2
  ...
  Dovrai accedere alla proprietà "name" di ogni oggetto in esso contenuto, e inserirla 
  nell'array "charactersNames" creato precedentemente.
...
for (i = 0; i < starWarsCharacters.length; i++) {
  let oggetto = starWarsCharacters[i];
  if (oggetto.gender === "female") {
...
/* ESERCIZIO 8
  ...
  dal valore "n/a" a "robot" (Tip: puoi effettuare la riassegnazione del valore corrispondente o 
